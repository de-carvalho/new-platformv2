...
export default function PersonalData() {
  ...
  useEffect(() => {
    api.get("users/profile").then((user) => {
      ...
      setOrigens(user.data.origens);
      setCredit(user.data.credit);
        ...
        <div className="content">
          ...
          {showData === 1 ? (
            ...
            <div className="perData">
              ...
              <h3>Editar informações - Motivos do crédito</h3>
              ...
              <div className="edit">
                <label>
                  ...
                  >
                    ...
                    <option value="Amigod">Amigod</option>
                ...
                <label>
                  ...
                  >
                    ...
                    <option value="Pagar dívida">Pagar dívida</option>
